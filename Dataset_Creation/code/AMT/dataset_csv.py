...
dataset_file = open('Dataset_SimpleQA_qualifiers_2000.json','r') #change the file name here to fetch the data from
...
index = len(new_tab.index)
#print(index)

tab1 = new_tab.iloc[:(index/2)]
...
final_tab.to_csv(r'Dataset_batch2_AMT.csv',encoding = 'utf-8',quoting = csv.QUOTE_ALL, index_label = 'Index') #change the file name for the different batches

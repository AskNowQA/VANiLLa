...
def loadDataset():
    ...
    train_data = TabularDataset(path='data/Final_Dataset_Train.json', format='json', fields=fields_tuple)
    print("Size of Training Set : {}".format(len(train_data)))
    print("Training Set Example: {}".format(train_data[0].__dict__))
    
    print("==> Loading Test Set")
    test_data = TabularDataset(path='data/Final_Dataset_Test.json', format='json', fields=fields_tuple)
